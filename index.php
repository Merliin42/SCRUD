		...
		<fieldset>
			...
			<div class="row">
				...
				<div class="form-group col-sm-3">
					<label for="connectHost" class="col-sm-2 col-form-label">Host</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="connectHost" id="connectHost">
					</div>
				</div>
				<div class="form-group col-sm-3">
					<label for="connectUser" class="col-sm-2 col-form-label">Utilisateur</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="connectUser" id="connectUser">
					</div>
				</div>
				<div class="form-group col-sm-3">
					<label for="connectPassword" class="col-form-label col-sm-12">Mot de passe</label>
					<div class="col-sm-10">
						<input type="password" class="form-control" name="connectPassword" id="connectPassword">
					</div>
				</div>
				<div class="form-group col-sm-2">
					<div class="col-sm-12" style="height: 2.25rem"></div>
